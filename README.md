...
`daemon --no-hotkeys` starts the companion without registering standalone global hotkeys or a tray icon, for hosts such as rMenu that own integrated shortcuts.
